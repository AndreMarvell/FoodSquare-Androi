 ...
 * Created by Marvell.
 */
public class RateService extends AsyncTask<String, Void, Boolean> {

    private String URL = "rates";
    private String TAG = "Webservice Note Restaurant";
    ...
    public RateService(Context context, String restaurantId){
    ...
    public Boolean rateRestaurant(String note) {
        ...
        try {
            ...
            jsonParams.put("rate", note);
            jsonParams.put("thread", "restaurant"+restaurantId);
            jsonParams.put("rater", FoodSquareApplication.USER.getId());
